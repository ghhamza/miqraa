...
function getDKBase() {
  if (typeof window !== "undefined" && window.__DK_BASE__) {
    return window.__DK_BASE__;
  }
  return "/digitalkhatt/";
}
...
class QuranService {
  ...
  constructor() {
    this.promise = this.instantiateWasm(getDKBase() + "VisualMetaFontWasm.wasm");
  }
  ...
  initilizeModule(wasmModule) {
    this.module = {
      ...
      preRun: [
        () => {
          const base = getDKBase();
          this.module.FS.createPreloadedFile(".", "mfplain.mp", base + "mfplain.mp", true, false);
          this.module.FS.createPreloadedFile(".", "ayah.mp", base + "ayah.mp", true, false);
          this.module.FS.createPreloadedFile(".", "mpguifont.mp", base + "mpguifont.mp", true, false);
          this.module.FS.createPreloadedFile(".", "myfontbase.mp", base + "myfontbase.mp", true, false);
          this.module.FS.createPreloadedFile(".", "digitalkhatt.mp", base + "digitalkhatt.mp", true, false);
          this.module.FS.createPreloadedFile(".", "parameters.json", base + "parameters.json", true, false);
          this.module.FS.createPreloadedFile(".", "automedina.fea", base + "automedina.fea", true, false);
        }],
      postRun: [],
      noInitialRun: true,
